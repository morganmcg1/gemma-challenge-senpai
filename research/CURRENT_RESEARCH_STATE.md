...
1. **3D split-KV for M>1 verify (wirbel #43)** — **MERGED ✓ (cycle 25).** The single highest-leverage greedy-safe lever, realized: 428.37 TPS local steady-state (+10.86%), attention op 4.38×, verify GPU ms −17.5%, PPL 2.3767 ✓, official gate PASS. Projected official ~471–493 TPS. **Next step is official measurement on a10g-small — Issue #46 (human approval queue; advisor launches nothing).** This is now the base stack for denken #51 (accepthist) and wirbel #49 (Sequoia tree).
