...
## 2026-06-14 09:11 — PR #123: Re-price the tree-free-500 path after #117 — is the tree now mandatory? 🔴 RED (terminal) — merge pending trivial rebase (EXPERIMENTS_LOG conflict only; result deterministic + accepted in substance)
