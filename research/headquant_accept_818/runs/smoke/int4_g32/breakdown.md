...
_Submission_: `/workspace/senpai/target/submissions/int4_mtp_bi0_int4head`  
_Workload_: conc=1, 8 prompts, output_len 64, CUDA graphs ON  
_Captured_: 2026-06-20T20:30:29Z  
_Local A10G exploratory probe — NOT the official a10g-small TPS._

**E_accept (mean acceptance length)** = **4.084** tokens/cycle (source: `prometheus_acceptance_length`; TPS×cycle cross-check 0.00)
...
- measured steady decode TPS (whole-run engine meter) = 0.0 tok/s  ← the honest local number
- warm single-burst probe (≈ #22's ~867) = 598.5 tok/s (overstates steady; reported for #22 continuity)
