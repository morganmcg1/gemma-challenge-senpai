...
_Captured_: 2026-06-20T20:23:15Z  
_Local A10G exploratory probe — NOT the official a10g-small TPS._

**E_accept (mean acceptance length)** = **4.203** tokens/cycle (source: `server_log_counters_exact`; TPS×cycle cross-check 0.00)
...
- measured steady decode TPS (whole-run engine meter) = 77.6 tok/s  ← the honest local number
- warm single-burst probe (≈ #22's ~867) = 508.0 tok/s (overstates steady; reported for #22 continuity)
