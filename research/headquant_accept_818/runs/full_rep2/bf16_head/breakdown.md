...
_Captured_: 2026-06-20T21:12:51Z  
_Local A10G exploratory probe — NOT the official a10g-small TPS._

**E_accept (mean acceptance length)** = **3.332** tokens/cycle (source: `server_log_counters_exact`; TPS×cycle cross-check 0.00)
...
- measured steady decode TPS (whole-run engine meter) = 211.2 tok/s  ← the honest local number
- warm single-burst probe (≈ #22's ~867) = 507.9 tok/s (overstates steady; reported for #22 continuity)
